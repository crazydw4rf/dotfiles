...
hl.curve("snappy", { type = "bezier", points = { { 0.25, 1.0 }, { 0.5, 1.0 } } })
...
hl.animation({ leaf = "fadeSwitch", enabled = true, speed = 2.0, bezier = "snappy" })
